...
public class MemoryScreenBlur : MonoBehaviour
{
    ...
    {
        return Max(Mathf.Exp(-(x * x + y * y) / (2 * standartDeviation * standartDeviation)) / (2 * Mathf.PI * standartDeviation * standartDeviation), 0);
    }
